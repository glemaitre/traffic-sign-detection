...
namespace imageprocessing {
  ...
  void removal_elt(std::vector< std::vector< cv::Point > > &contours, std::vector< cv::Vec4i > hierarchy, const cv::Size& size_image, const long int& areaRatio = 1500, const double& lowAspectRatio = 0.5, const double& highAspectRatio = 1.3);
